	...
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li><a href="users_admin.php"class="active"><span class="fas fa-users"> </span><span> Users </span> </a></li>
...
<!--PHP Table-->
<div class="table">
		<button id="modalBtn" class="modal-btn">Add User</button>
		<!--Add Product
		...
		<div id="simpleModal"class="modal">
			<div class="modal-content">
				...
				<div class="modal-body">	
					...
					<form action='addusers_admin.php' method='POST' class="signup">
	...
	<tr>
		...
		<td> 
			...
			<!--<a href="#updateModal=<?php //echo $user['userID'];?>"><button id="modalBtn2" class="btn-success"> EDIT</button></a>-->
			...
			<a href="?deletecat=<?php echo $user['userID'];?>" type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete User <?php echo $user['username'];?> ?')">DELETE</a>
		</td>
	</tr>
	...
	<!--DELETING ITEM -->
		...
		<div id="updateModal=<?php echo $user['userID'];?>" class="updatemodal">
			<div class="modal-content">
				...
				<div class="modal-body">	
				<form action="updateusers2.php?myid=<?php echo $user['userID'];?>" method="POST">
